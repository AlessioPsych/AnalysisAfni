...
setwd('/analyse/Project0226/GN18NE278_KMA25_FEF_28092018_nifti')
mainDir <- getwd()
args <- c('meanTsEye_res_mask.nii.gz', 'meanTsEye_res.nii.gz', 'output_test_eye_test_fix','/home/alessiof/abin', '1', '4','1','0.166')
...
setwd('/analyse/Project0226/scanner_train - Copy/orientationgrating_points_fit_long_glas_large_fixation_get_stimuli')
...
yPosFit <- seq( min(y)-addSpace, max(y)+addSpace, length.out=9 )

...
Rscript $AFNI_TOOLBOXDIRCOREGISTRATION/segment_white_matter_20112018_03_no_ants.R $ANATFILE $AFNI_INSTALLDIR $AFNI_TOOLBOXDIRSURFACES $AFNI_ATLASDIR_TOOLBOX $CLUSTPROPLOCAL $CLUSTPROPGLOBAL $NITER $DISTANCETHR $AFNI_TOOLBOXDIRCOREGISTRATION $BIAS $PARAMWM $PARAMCLEAN

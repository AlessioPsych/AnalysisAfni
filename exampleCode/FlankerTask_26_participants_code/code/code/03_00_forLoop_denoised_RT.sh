...
foreach i (`cat subjList.txt`)
    echo instr: tcsh $code_folder/03_01_sub_xx_afni_proc_denoised_RT.sh $i $main_folder $input_folder
    echo instr mv ${i}.results $output_folder
    tcsh $code_folder/03_01_sub_xx_afni_proc_denoised_RT.sh $i $main_folder $input_folder

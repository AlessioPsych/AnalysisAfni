...
Rscript $AFNI_TOOLBOXDIR/devel/twoDimensionalFit_Glasgow_eyeFix_gain_parallel_twoSteps.R $MASKFILE $TSFILE $OUTPUTNAME $AFNI_INSTALLDIR $FLAGSURROUND $POLORT $FITINTERCEPT $STIMTYPE $FITTEDPARAMETERS $PREDICTEDTS

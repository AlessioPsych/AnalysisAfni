...
# to run ' sh 01_03_make_Timings_mrtrix3.sh '

maindir="/mnt/disk01/ds000102_FlankerTask/derivatives/mrtrix3"
...
for subj in `cat subjList.txt`; do
	...
	cat ${subj}_task-flanker_run-1_events.tsv | awk '{if ($5=="incorrect") {print $1, $2, 1}}' > incorrect_run1.txt
	...
	cat ${subj}_task-flanker_run-2_events.tsv | awk '{if ($5=="incorrect") {print $1, $2, 1}}' > incorrect_run2.txt
...
#Now convert to AFNI format
	...
	timing_tool.py -fsl_timing_files incorrect*.txt -write_timing incorrect.1D

...
echo "resample: master dataset ..."
3dresample -orient RAI -rmode NN -input $qR1 -dxyz $outputResX $outputResY $outputResZ -prefix masterDataset.nii.gz
cp masterDataset.nii.gz $maindir/$outputdir/masterDataset.nii.gz
...
3dresample -rmode NN -input $cruiseLeft -dxyz $outputResX $outputResY $outputResZ -master masterDataset.nii.gz -prefix $newname
...
3dresample -rmode NN -input $cruiseRight -dxyz $outputResX $outputResY $outputResZ -master masterDataset.nii.gz -prefix $newname
mv $newname $maindir/$outputdir/$newname
...
echo "resample: $qR1"
3dresample -rmode Linear -input $qR1 -dxyz $outputResX $outputResY $outputResZ -master masterDataset.nii.gz -prefix $newname
mv $newname $maindir/$outputdir/$newname
...
echo "resample: $qR2"
3dresample -rmode Linear -input $qR2 -dxyz $outputResX $outputResY $outputResZ -master masterDataset.nii.gz -prefix $newname
mv $newname $maindir/$outputdir/$newname
...
echo "resample: $Biel"
3dresample -rmode Linear -input $Biel -dxyz $outputResX $outputResY $outputResZ -master masterDataset.nii.gz -prefix $newname
mv $newname $maindir/$outputdir/$newname
...
echo "resample: $PD"
3dresample -rmode Linear -input $PD -dxyz $outputResX $outputResY $outputResZ -master masterDataset.nii.gz -prefix $newname
mv $newname $maindir/$outputdir/$newname

echo "remove master dataset..."
rm masterDataset.nii.gz

echo "moving into output folder..."

...
echo
echo 'T1MPRAGE_SS_RAI=$1, MP2RAGE T1 contrast, skull stripped in RAI coordinates (check 3dresample with -orient RAI flag)'
echo
exit 1
fi

cp $T1MPRAGE_SS_RAI _ttt_T1_MPRAGE_RAI.nii.gz


run_nighres_command.sh 'brain.mgdm_segmentation(contrast_image1="_ttt_T1_MPRAGE_RAI.nii.gz", contrast_type1="Mprage3T", save_data=True, file_name="MP2RAGE_seg", output_dir="nighres_resultsMP2RAGE/", n_steps=5, max_iterations=800)'
...
cp nighres_resultsMP2RAGE/left_cerebrum/cruise_left/MP2RAGE_seg_cruise_left_cruise_cortex.nii.gz nighres_resultsMP2RAGE/ 
cp nighres_resultsMP2RAGE/right_cerebrum/cruise_right/MP2RAGE_seg_cruise_right_cruise_cortex.nii.gz nighres_resultsMP2RAGE/ 
cp nighres_resultsMP2RAGE/left_cerebrum/cruise_left/MP2RAGE_seg_cruise_left_cruise_thick.nii.gz nighres_resultsMP2RAGE/ 
cp nighres_resultsMP2RAGE/right_cerebrum/cruise_right/MP2RAGE_seg_cruise_right_cruise_thick.nii.gz nighres_resultsMP2RAGE/ 

rm _ttt_T1_MPRAGE_RAI.nii.gz

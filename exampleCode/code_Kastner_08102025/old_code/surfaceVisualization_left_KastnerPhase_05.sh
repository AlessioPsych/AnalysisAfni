...
DriveSuma -echo_edu -com surf_cont -load_dset zzz_phase_encoded_wAverage_05_correct_anat_add_interp_surfaces_folder_left/boundary01_sm_zzz_phase_encoded_wAverage_05_correct_anat_add_surf.1D.dset -surf_label ICO -view_surf_cont y

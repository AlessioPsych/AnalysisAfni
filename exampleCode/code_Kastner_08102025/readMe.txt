...
15_00_expecedResponseBasedOnContrast.R

	generates the 2D stimuli corresponding to the active eye movements (shift towards the equal and opposite direction) + contrast	
	
15_01_responseBasedOnContrast_getRoisData.R

	gets the results from 15_00 and the rois from 09_ and saves the output R2, intercept and slope for each individual, for the cw and ccw contrast-based case

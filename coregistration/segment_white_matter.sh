...
Rscript $AFNI_TOOLBOXDIRCOREGISTRATION/segment_white_matter.R $ANATFILE $AFNI_INSTALLDIR $AFNI_TOOLBOXDIRSURFACES $AFNI_ATLASDIR $CLUSTPROPLOCAL $CLUSTPROPGLOBAL $NITER $DISTANCETHR $AFNI_TOOLBOXDIRCOREGISTRATION $BIAS $COUNTERS $CLASSID

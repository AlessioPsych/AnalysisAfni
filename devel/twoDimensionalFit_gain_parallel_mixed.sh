...
echo 'STIMTYPE=$8: 1:mixed model; 2:eye fix border; 3:eye moving;'
...
Rscript $AFNI_TOOLBOXDIR/devel/twoDimensionalFit_Glasgow_eyeFix_gain_parallel_mixed.R $MASKFILE $TSFILE $OUTPUTNAME $AFNI_INSTALLDIR $FLAGSURROUND $POLORT $FITINTERCEPT $SAMPLINGTIME $STIMTYPE 

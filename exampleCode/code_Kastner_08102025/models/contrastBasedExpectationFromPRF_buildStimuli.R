...
for ( counterImage in 1:length( thetaExp[1:10] ) ) { # counterImage <- 1
  ...
  for ( stepCounter in seq(7,19,2) ) { # stepCounter <- 7
    circleMask <- ( mesh2dCoords$X^2 + mesh2dCoords$Y^2 > 8 ) & ( mesh2dCoords$X^2 + mesh2dCoords$Y^2 < 18 ) # mask

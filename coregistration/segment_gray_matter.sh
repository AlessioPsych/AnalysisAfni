...
Rscript $AFNI_TOOLBOXDIRCOREGISTRATION/segment_gray_matter_two_steps.R $ANATFILE $WHITEMATTERMASK $AFNI_INSTALLDIR $AFNI_TOOLBOXDIRSURFACES $AFNI_ATLASDIR $THR

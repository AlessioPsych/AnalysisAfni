...
DriveSuma -echo_edu -com surf_cont -load_dset zzz_phase_encoded_wAverage_05_correct_anat_add_interp_surfaces_folder_right/boundary01_sm_zzz_phase_encoded_wAverage_05_correct_anat_add_surf.1D.dset -surf_label ICO -view_surf_cont y

#DriveSuma -echo_edu -com surf_cont -switch_dset Convexity

#DriveSuma -echo_edu -com surf_cont T_val 5

DriveSuma -echo_edu -com surf_cont -switch_dset boundary01_sm_zzz_phase_encoded_wAverage_05_correct_anat_add_surf.1D.dset

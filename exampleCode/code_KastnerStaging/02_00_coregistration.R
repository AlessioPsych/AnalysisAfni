...
for ( nSession in 34:35) { # length( epiSessions ) nSession <- 34; check session 20
  
  if (nSession==1) {
    nudgeString <- '-rotate 0.00I 0.00R 0.00A -ashift 16.00S 0.00L 12.00P'
    oldCoregFlag <- 0
  }
  if (nSession==2) {
    nudgeString <- '-rotate 0.00I 0.00R 0.00A -ashift 16.00S 0.00L 12.00P'
  ...
  if (nSession==7) {
    nudgeString <- '-rotate 0.00I 21.00R 0.00A -ashift 28.00S 0.00L 2.00P'
    oldCoregFlag <- 0
  }
  if (nSession==8) {
    nudgeString <- ''
  ...
  if (nSession==12) { 
    nudgeString <- '-rotate 0.00I 0.00R 0.00A -ashift 12.00S 0.00L 2.00P'
    oldCoregFlag <- 0
  }
  if (nSession==13) { 
    nudgeString <- '-rotate 0.00I 0.00R 0.00A -ashift 15.00S 0.00L 3.00P'
    oldCoregFlag <- 0
  }
  if (nSession==14) { 
    nudgeString <- '-rotate 0.00I 0.00R 0.00A -ashift 14.00S 0.00L 5.00P'
    oldCoregFlag <- 0
  }
  if (nSession==15) {
    nudgeString <- '-rotate -3.02I 5.99R 0.32A -ashift 13.92S -0.39L 7.45P'
    oldCoregFlag <- 0
  }
  if (nSession==16) {
    nudgeString <- '-rotate -3.02I 5.99R 0.32A -ashift 13.92S -0.39L 7.45P'
  ...
  if (nSession==17) {
    nudgeString <- '-rotate 0.00I 0.00R 0.00A -ashift 20.00S 0.00L 12.00P'
    oldCoregFlag <- 0
  }
  if (nSession==18) {
    nudgeString <- '-rotate 0.00I 0.00R 0.00A -ashift 18.00S 0.00L 16.00P'
    oldCoregFlag <- 0
  }
  if (nSession==19) {
    nudgeString <- '-rotate 0.00I 20.00R 0.00A -ashift 17.22S 0.00L 2.94P'
    oldCoregFlag <- 0
  }
  if (nSession==20) {
    nudgeString <- '-rotate 0.00I 20.00R 0.00A -ashift 19.95S 0.00L 1.70P'
    oldCoregFlag <- 0
  }
  if (nSession==21) {
    nudgeString <- '-rotate 0.00I 16.00R 0.00A -ashift 18.00S 0.00L 0.00P'
    oldCoregFlag <- 0
  }
  if (nSession==22) {
    nudgeString <- '-rotate 0.00I 0.00R 0.00A -ashift 24.00S 0.00L 12.00P'
    oldCoregFlag <- 0
  }
  if (nSession==23) {
    nudgeString <- '-rotate 0.00I 0.00R 0.00A -ashift 24.00S 0.00L 12.00P'
  ...
  if (nSession==24) {
    nudgeString <- '-rotate 0.00I 0.00R 0.00A -ashift 18.00S 0.00L 2.00P'
    oldCoregFlag <- 0
  }
  if (nSession==25) {
    nudgeString <- '-rotate 0.00I 0.00R 0.00A -ashift 18.00S 0.00L 2.00P'
  ...
  if (nSession==27) {
    nudgeString <- '-rotate 0.00I 0.00R 0.00A -ashift 14.00S 0.00L 0.00P'
    oldCoregFlag <- 0
  }
  if (nSession==28) {
    nudgeString <- '-rotate 0.00I 0.00R 0.00A -ashift 12.00S 0.00L 0.00P'
    oldCoregFlag <- 0
  }
  if (nSession==29) {
    nudgeString <- '-rotate 0.00I 0.00R 0.00A -ashift 18.00S 0.00L 0.00P'
    oldCoregFlag <- 0
  }
  if (nSession==30) {
    nudgeString <- '-rotate 0.00I 6.00R 0.00A -ashift 14.89S 0.00L 11.20P'
    oldCoregFlag <- 0
  }
  if (nSession==31) {
    nudgeString <- '-rotate 0.00I 6.00R 0.00A -ashift 14.89S 0.00L 11.20P'
  ...
  if (nSession==32) {
    nudgeString <- '-rotate 0.00I 12.00R 0.00A -ashift 18.59S 0.00L 2.03P'
    oldCoregFlag <- 0
  }
  if (nSession==33) {
    nudgeString <- '-rotate 0.00I 12.00R 0.00A -ashift 18.59S 0.00L 2.03P'
  ...
  if (nSession==34) {
    nudgeString <- '-rotate 0.00I 0.00R 0.00A -ashift 16.00S 0.00L 8.00P'
    oldCoregFlag <- 0
  }
  if (nSession==35) {
    nudgeString <- '-rotate 0.00I 0.00R 0.00A -ashift 16.00S 0.00L 8.00P'

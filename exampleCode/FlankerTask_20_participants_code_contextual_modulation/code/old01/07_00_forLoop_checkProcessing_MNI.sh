...
set output_folder = "derivatives/images_afni_MNI_from_denoised_data"
set input_folder = "derivatives/processing_afni_MNI_denoised"
...
foreach i (`cat subjList.txt`)	
    cd $maindir
    cd $codedir
    tcsh 07_01_visualizeProcessed_MNI.sh $i $output_folder $input_folder $maindir
end

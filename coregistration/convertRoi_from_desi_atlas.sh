...
if [ -z "$1" ]
 then
  ...
  echo
  echo 'example call: convertRoi_from_desi_atlas.sh MPRAGE_at.Xat.1D anatomyN3.nii.gz /usr/share/afni/atlases/TT_caez_lr_18+tlrc 1 Qwarp_WARPINV+tlrc'
  exit 1
fi
...
Rscript $AFNI_TOOLBOXDIR/generalPurpose/runCommandViaR.R $instr1

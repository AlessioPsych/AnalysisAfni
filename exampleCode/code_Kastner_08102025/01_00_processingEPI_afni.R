...
epiDir <- '/media/alessiofracasso/DATADRIVE1/KastnerData/staging_area_Kastner/epi_data'
anatomyDir <- '/media/alessiofracasso/DATADRIVE1/KastnerData/staging_area_Kastner/anatomies_KastnerClassic_Freesurfer/'
...
for ( nSession in 999:999) { # length( epiSessions ) nSession <- 1

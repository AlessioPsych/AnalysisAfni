...
load( file='results_Wang_ORIG_Denoised_singleVoxel.RData' )
output_ORIG_Denoised <- outputDataset
output_ORIG_Denoised$voxelValue
output_ORIG_Denoised_agg <- aggregate( voxelValue ~ participantID * coefficient * side * roi * roiIdx, data=output_ORIG_Denoised, FUN=median )

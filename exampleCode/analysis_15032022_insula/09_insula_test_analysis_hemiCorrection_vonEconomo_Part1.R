...
filesList = filesList[1:104] # Comment out this line + the lines for generating AFNI files to generate plots easily
...
save(aggregateProfilesMat_combined, file = "/analyse/Project0165/Fracasso_Anatomy/AHEAD_database/10007840/analysis_15032022/aggregateProfilesMat_combined_VonEconomo_1.RData")
...
save.image("/analyse/Project0165/Fracasso_Anatomy/AHEAD_database/10007840/analysis_15032022/09_data_vonEconomo1_lm_save.RData")
...
ifelse(nFile > 2, plotData(aggregateProfilesMat_combined, "vonEconomo_AHEAD_Average"),plotData(aggregateProfilesMat_combined, participantName))

...
inputDirEpi <- '/scratch/af4887/Proj_Gaia_David/EPI_timeSlicedCorrected_Threat'
...
outputDir <- '/scratch/af4887/Proj_Gaia_David/afni_processed_Threat'
setwd( mainDir )
...
for ( nSubj in 28 : 30  ) { # nSubj <- 1 length( singleSubjectFolders )
  ...
  instr <- paste( 'afni afni_proc.py',
                  ...
                  '-regress_stim_labels anx_rat color fix mem_resp mem_test scream T1 T2',

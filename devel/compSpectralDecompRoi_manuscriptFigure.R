...
vertexF <- t( U[,1:10] ) * t( array( rep( sqrt( S[1:10] ), c(n,n,n,n,n,n,n,n,n,n) ), c(n,10) ) )
...
print('n:')
print( n )
print('vertexF dimension:')
print( dim(vertexF) )
print( '...' )
print( '...' )
print('U[,1:2] dimension:')
print( dim(U[,1:2]) )
print('rep( sqrt( S[1:2] ), c(n,n) ) dimension:')
print( length( rep( sqrt( S[1:2] ), c(n,n) ) ) )
print('t( array( rep( sqrt( S[1:2] ), c(n,n) ), c(n,2) ) )')
print( t( array( rep( sqrt( S[1:3] ), c(n,n,n) ), c(n,3) ) ) )
...
vertexFC <- vertexF - t( array( rep( vertexF[ , idxCenter ], c(n,n,n,n,n) ), c(n,5) ) )

...
DriveSuma -echo_edu -com surf_cont -load_dset ppp_prf_nocss_params_anat_add_interp_surfaces_folder_right/boundary01_sm_ppp_prf_nocss_params_anat_add_surf.1D.dset -surf_label ICO -view_surf_cont y
...
DriveSuma -com surf_cont -load_cmap /analyse/Project0226/KastnerModel/code/bensonRight.niml.cmap #Color_circle_ZSS

...
echo 'STIMTYPE=$8: 1:eye moving; 2:eye fix; 3:eye fix border; 4:prf'
...
Rscript $AFNI_TOOLBOXDIR/devel/twoDimensionalFit_Glasgow_eyeFix_gain_parallel_multPar.R $MASKFILE $TSFILE $OUTPUTNAME $AFNI_INSTALLDIR $FLAGSURROUND $POLORT $FITINTERCEPT $SAMPLINGTIME $STIMTYPE 

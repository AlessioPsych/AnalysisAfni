...
testSubjectDir <- '/analyse/Project0226/KastnerModel/staging_area_Kastner/anatomies_KastnerClassic_Freesurfer/ASM16_ANATOMY/FreeSeg_result/SUMA/pRFModelSurfaces1D'

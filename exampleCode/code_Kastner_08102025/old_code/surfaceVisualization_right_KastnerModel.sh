...
DriveSuma -echo_edu -com surf_cont -load_dset zzz_kastner_model_params_anat_add_interp_surfaces_folder_right/boundary01_sm_zzz_kastner_model_params_anat_add_surf.1D.dset -surf_label ICO -view_surf_cont y

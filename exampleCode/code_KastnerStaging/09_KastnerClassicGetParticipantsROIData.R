...
paramsFileCwCCw <- list.files( path=getwd(), pattern='*params*', recursive = FALSE, full.names = FALSE  )
paramsFileWAverage <- list.files( path=getwd(), pattern='*wAverage*', recursive = FALSE, full.names = FALSE  )
paramsFileTrWaveCwCCw <- list.files( path=getwd(), pattern='*trWave*', recursive = FALSE, full.names = FALSE  )

allParamsTemp <- c( paramsFileCwCCw, paramsFileWAverage, paramsFileTrWaveCwCCw )
allParams <- c()
...
setwd( resultsFolder )
print( getwd() )
dirToCheck <- sprintf('KastnerClassic_hrf_modulation' )

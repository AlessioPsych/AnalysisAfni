for (nSubj in 7:8) {
  ...
  #figuresDir <- '/analyse/Project0226/DanielaProject/papers_report/figures'
  ...
  instr <- 'denoiseData.sh EPI_mask/ *.nii 12 EPI_denoise/'; system( instr )
  ...
  instr <- 'motionCorrect.afni.blip.sh EPI_timeSlice/ TOPUP/ 3 1 3-6-8 1-2-3 7 -1'; system( instr )
